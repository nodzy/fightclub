...
test "new user" do
 ...
 assert_no_difference ['User.count'] do
  post users_path, user: {first_name: "" , last_name: "", level: 3, midichlorians: 3, lightsaber: 4, force: 'Light' }, format: :js
end
assert_difference ['User.count'], 1 do
  post users_path, user: {first_name: "Example" , last_name: "User", level: 3, midichlorians: 3, lightsaber: 4, force: 'Light' }, format: :js
end
